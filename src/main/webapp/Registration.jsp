...
<div class="bg-white p-8 rounded shadow-md w-full max-w-lg">
    <h2 class="text-2xl font-bold mb-6 text-center text-orange-700">Register as a User</h2>
  ...
  <!-- Submit -->
        <div class="text-center">
            <button type="submit"
             ...
             Do you have Account..?<a href="login.jsp" class="text-orange-600 hover:underline">
